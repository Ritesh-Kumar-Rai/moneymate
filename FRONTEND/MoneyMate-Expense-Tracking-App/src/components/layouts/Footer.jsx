...
const Footer = () => {
    return (
        <footer class="text-center mt-2 p-4">
            ...
            <span class="block text-sm text-center text-gray-500">© 2025-2026 MoneyMate™. All Rights Reserved.
                Built with <a
                    href="https://tailwindcss.com" class="text-purple-600 hover:underline">Tailwind
                    CSS
                </a> and by <a href="#" class="text-purple-600 hover:underline">@RITESHKUMARRAI</a>.
            </span>
