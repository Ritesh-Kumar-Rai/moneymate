    ...
    return (
        <div className="mt-10 w-full">
            ...
            <table className="mt-5 w-full table-auto border-collapse border border-gray-400 bg-slate-200 dark:bg-gray-800 rounded overflow-hidden outline-1 outline-dashed outline-slate-400 shadow-2xl">
                <caption className="caption-bottom mt-2">Recent 10 transactions of both income and expenses</caption>
                ...
                <tbody>
                    <tr>
                        ...
                        <td className="border border-gray-600 px-3 py-2 text-center relative">
                            <span className="absolute left-[-7%] rounded-2xl bg-indigo-800 hover:bg-indigo-500 active:scale-90 text-white w-[50px] text-center cursor-pointer transition-scale-bg duration-200 will-change-transform select-none" title="swap currency"><CgSwap className="text-2xl m-auto" /> </span>
                            $890373
                        </td>
